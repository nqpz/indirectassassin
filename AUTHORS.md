Authors of Indirect Assassin
============================

See COPYING.txt for details about licenses and the Liberated Pixel Cup.


Code author
-----------

Indirect Assassin is written by Niels G. W. Serup <ns@metanohi.name>.
...
By Niels G. W. Serup. To the extent possible under law, Niels G. W. Serup has
waived all copyright and related or neighboring rights to these maps; see the
Creative Commons Zero 1.0 document for more information.
...
A font from the Aenigma fonts package. By Brian Kent. Licensed under the
Artistic License 2.0. See
http://packages.debian.org/changelogs/pool/main/t/ttf-aenigma/ttf-aenigma_0.0.20080510.dfsg-2/ttf-aenigma.copyright
